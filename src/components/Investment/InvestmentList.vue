...
const EI_VENTURES_SHARE_PRICE = 4.94; // magic number
...
const pickers = [
  ...
  (invt) =>
    normalAndDealmaker([
      invt.invt_shares
        ? (EI_VENTURES_SHARE_PRICE * invt.invt_shares).toLocaleString("en-US", {
            style: "currency",
            currency: "USD",
          })
        : null,
      invt.invt_shares_dm
        ? (EI_VENTURES_SHARE_PRICE * invt.invt_shares_dm).toLocaleString(
            "en-US",
            {
              style: "currency",
              currency: "USD",
